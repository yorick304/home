...
function(a) {
	function b() {
		var b = (new Date).getTime() - new Date(2016, 7, 26, 20, 0, 0).getTime(),
			c = b % 31104e6,
			d = c % 2592e6,
			e = d % 864e5,
			f = e % 36e5;
	...
	function e() {
		var b = document.getElementById("smohan-v4-music"),
			c = b.getAttribute("data-music-src").split(','),
            i = document.getElementById('music-img'),
            iArr = i.getAttribute('data-src').split(','),
            ...
            imgLink = iArr[rand];
		i.src = imgLink;
		b.setAttribute('title',mLink.split('/')[1].split('.')[0]);
		return "N" != e ? (
	...
	function g() {
		document.addEventListener("keydown", function(a) {
			...
			document.title = document.hidden ? "看这里，看这里!" : "Jake's Blog"
		})
	}
